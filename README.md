...
Created a decentralized crypto token **"DCT"** from scratch on the ICP blockchain network using back-end logic. Developed an NFT marketplace using **React** where users can discover NFT collections, buy from it, mint NFTs, and list their NFTs for sale. Integrated the **DCT token wallet** as the payment method for transactions.
